...
<html>
    <head>
        <title>Cetak Data Karyawan Tetap Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA KARYAWAN TETAP BULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                                <tr>
                                    ...
                                    <th width="14%">
                                        ...
                                        </th><th width="10%">Pendidikan Terakhir</th>
                                        </th><th width="10%">Tgl Masuk</th>
                                </tr>
                                </thead>
                            <tbody>
                            ...
                            $sql = "SELECT * FROM tb_karyawan WHERE substr(tgl_masuk,1,7)='$ambilthn-$ambilbln'";
