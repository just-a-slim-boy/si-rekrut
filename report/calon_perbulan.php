...
<html>
    <head>
        <title>Cetak Data Calon Karyawan Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA CALON KARYAWAN BULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM tb_pelamar WHERE substr(tgl_masuk,1,7)='$ambilthn-$ambilbln'";
